...
#include "../../TrafficSimulation/src/simulationcontroller.h"
...
QT_MOC_LITERAL(1, 21, 7), // "advance"
QT_MOC_LITERAL(2, 29, 0) // ""

    },
    "SimulationController\0advance\0"
};
...
void SimulationController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SimulationController *_t = static_cast<SimulationController *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject SimulationController::staticMetaObject = {
    { &QGraphicsScene::staticMetaObject, qt_meta_stringdata_SimulationController.data,
      qt_meta_data_SimulationController,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SimulationController::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SimulationController.stringdata0))
        return static_cast<void*>(const_cast< SimulationController*>(this));
